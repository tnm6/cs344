"""
    ...
    Altered to include solution GPS cannot solve
...
problem = {
    ...
    'initial': ['space on a', 'a on table', 'space on b', 'b on table',
            'space on c', 'c on table'],
    # Goal states which GPS can solve (bottom to top)
    # 'goal': ['c on table', 'b on c', 'a on b', 'space on a'],
    # Goal states which GPS cannot solve (identical, now top to bottom)
    'goal': ['space on a', 'a on b', 'b on c', 'c on table'],
...
if __name__ == '__main__':
    ...
    # Use GPS to attempt to solve problem
    action_sequence = gps(
        problem['initial'],
        problem['goal'],
        problem['actions']
